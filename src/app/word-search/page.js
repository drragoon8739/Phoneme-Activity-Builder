  ...
  return (
    <>
      <header>
        ...
        <p className="lede">
          Choose a small set of words from the HCE corpus. Each cell holds one
          phoneme, so students segment sounds rather than scan for letters. The
          grid you approve here is the grid that gets exported.
        </p>
      </header>
